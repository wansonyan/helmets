...
def parse_args():
    ...
    parser.add_argument('--raw_label_dir', help='the path of raw label', default=r'E:\helmetcase\blue\test\labels')
    parser.add_argument('--pic_dir', help='the path of picture', default=r'E:\helmetcase\blue\test\images')
    parser.add_argument('--save_dir', help='the path of new label', default=r'E:\helmetcase\blue\test\json')
